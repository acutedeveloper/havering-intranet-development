 ...
 * @see WP_Widget
 */
class HI_Widget_Archives extends WP_Widget {
	...
	public function __construct() {
		$options = array(
			'description' => 'Add the news archive to the sidebar.',
			'name' 	=> 'Intranet News Archive',
		);

		parent::__construct('HI_Archives_Widget','',$options);
	}
	...
	public function widget( $args, $instance ) {
		...
		<?php } else { ?>
		<div class="b-container"><ul class="sidebar-links">
		<?php
		/**
