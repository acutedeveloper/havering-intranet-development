...
function help_with_work_cpt() {
	...
	$labels = array(
		'name'                  => _x( 'Help with work', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Help with work', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Help with work', 'text_domain' ),
		'name_admin_bar'        => __( 'Help with work', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'Help with work', 'text_domain' ),
		'description'           => __( 'Help with work', 'text_domain' ),
		'labels'                => $labels,
...
add_action( 'init', 'help_with_work_cpt', 0 );


function help_with_work_tax() {

	$labels = array(
		'name'                       => _x( 'Help with work categories', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'              => _x( 'Help with work category', 'Taxonomy Singular Name', 'text_domain' ),
		'menu_name'                  => __( 'Help with work categories', 'text_domain' ),
		'all_items'                  => __( 'All Items', 'text_domain' ),
	...
	register_taxonomy( 'help-with-work', array( 'help-with-work' ), $args );

}
add_action( 'init', 'help_with_work_tax', 0 );
...
function human_resources_post_type() {
	...
	$args = array(
		'label'                 => __( 'Human Resources', 'text_domain' ),
